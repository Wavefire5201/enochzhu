...
export const projectEntries: (z.input<typeof projectSchema> & {
	...
	},
	{
		...
		title: "cuaya",
		description:
			"pre-health app with a provider directory over 2.9m us healthcare records, searched in 7ms with postgis knn, plus a clinical hours tracker tiered against admissions targets",
		stack: [
			"react-native",
			"expo",
			"hono",
	...
	},
	{
		...
		title: "private cloud",
		description:
			"self-hosted linux homelab across 3 hosts running 20+ containers behind nginx with zero public ingress, serving production backends for sbi and cuaya, with netdata alarms on disk, cpu, and memory across 4tb+",
		stack: [
			"linux",
			"docker",
			"dokploy",
